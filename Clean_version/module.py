...
class EchoStateNetwork:
    ...
    def __init__(self, n, spectral_radius=0.9, avg_number_of_edges=2, alpha = 0.1, proxy_discard = 50, goal_discard = 100, measure_time = 50):
        """
        ...
        self.n = n
        self.goal = [n-1]
        self.action_nodes = [k for k in range(16)]
